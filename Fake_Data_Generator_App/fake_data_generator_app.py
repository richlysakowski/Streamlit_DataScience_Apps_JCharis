...
def main():
	...
	if choice == "Home":
		...
		#profile_options_list = ["FirstName", "LastName", "TechSupportRole", "Region",  "Country", "Manager", "BusinessUnit"]		
  		#profile_tech_support_app = ["FirstName", "LastName", "TechSupportRole", "Region",  "Country", "Manager", "BusinessUnit"]
